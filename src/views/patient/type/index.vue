<template>
  <div class="app-container">
    ...
    >
      <el-table-column prop="typeName" label="患者类型名称" width="260"></el-table-column>
      <el-table-column prop="leader" label="负责人" width="100"></el-table-column>
      <el-table-column prop="typeDescribe" label="描述" :show-tooltip-when-overflow="true"></el-table-column>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          <el-button
            ...
            v-hasPermi="['patient:type:remove']"
          >删除
          </el-button>
        </template>
      </el-table-column>
        ...
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="描述" prop="typeDescribe">
              <el-input v-model="form.typeDescribe" type="textarea" autosize placeholder="请输入类型描述"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        parentId: [
          {required: true, message: "上级患者类型不能为空", trigger: "blur"}
        ],
        typeName: [
          {required: true, message: "患者类型名称不能为空", trigger: "blur"}
        ],
        orderNum: [
